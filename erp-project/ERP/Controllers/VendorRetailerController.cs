...
{
    public class VendorRetailerController : AlertController
    {
        ...
        {
            var userMas = db.UserMas.Include(u => u.Employee).Where(x=>x.UserType==0);
        ...
        public JsonResult DeleteVendor(int id)
        {
            ...
            try
            {
                ...
                var findRetailer = db.PurchaseOrder.Where(x => x.UserMasId == id).ToList();
        ...
        //        //var userMasId = db.VendorRetailerItems.SingleOrDefault(x => x.UserMasId == VPayId).UserMasId;
        //        var itemsToDeleteVendor = db.UserDet.Where(x => x.UserMasId == id);
        //        db.UserDet.RemoveRange(itemsToDeleteVendor);



        //        var itemsToDeleteUserMas = db.UserMas.Where(x => x.Id == id);


        //        db.UserMas.RemoveRange(itemsToDeleteUserMas);
